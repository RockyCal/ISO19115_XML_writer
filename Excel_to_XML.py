...
def removeGraphic(MD_dataID, graphicOverview):
    if fileNameString.text=="":
        MD_dataID.remove(graphicOverview)

# Removes thesaurus element if resource has no thesaurus        
def removeThesaurus(MD_dataID, descriptivekeywords):
...
def removeConstraints(MD_dataID, resourceConstraints):
    if useLimitationMDString.text=="":
        resourceConstraints.remove(MD_Constraints)
    ...
    if useLimitString.text=="" and access_RestrictionCode.text=="" and use_RestrictionCode.text==""and otherString.text=="":
        resourceConstraints.remove(MD_LegalConstraints)
    ...
    if useLimitationString.text=="" and MD_ClassificationCode.text=="" and userNoteString.text=="" and classSysString.text=="" and handlingString.text=="":
        resourceConstraints.remove(MD_SecurityConstraints)
    return MD_dataID

# Removes data quality data if resources has no explicit report
# Also necessary if resource is actually a database to other
# datasets
def removeQuality(root):
    if MD_ScopeCode.text=="":
        root.remove(dataQualityInfo)
    return root

# Using comma as a delimiter, separates each keyword into its own subelement
def separateKeywords(MD_Keywords, keywordsEntered, length):
    for i in range(0, length):
        keyword=SubElement(MD_Keywords, '{http://www.isotc211.org/2005/gmd}keyword')
        keywordString=SubElement(keyword, '{http://www.isotc211.org/2005/gco}CharacterString')
        keywordString.text=keywordsEntered[i]
    return MD_Keywords.append(keyword)

def makeTopicCategories(parentElem, categoriesEntered, length):
    for i in range(0, length):
        topicCategory=SubElement(MD_dataID, '{http://www.isotc211.org/2005/gmd}topicCategory')
        MD_TopicCategoryCode=SubElement(topicCategory, '{http://www.isotc211.org/2005/gmd}MD_TopicCategoryCode')
        aCategory=categoriesEntered[i]
        MD_TopicCategoryCode.text=str(matchTopicCategory(aCategory))
    return parentElem.append(topicCategory)

def matchTopicCategory(aCategory):
    return {
...
for i in range(106, 107):   #range of resources; starts at 1 because first row is column headers
    ...
    MD_ScopeCode = SubElement(hierarchyLevel, '{http://www.isotc211.org/2005/gmd}MD_ScopeCode', {'codeList':'http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_ScopeCode',
    ...
    CI_RoleCode=SubElement(role, '{http://www.isotc211.org/2005/gmd}CI_RoleCode', {'codeList':'http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#CI_RoleCode',
    ...
    # When using xlrd, dates are returned as doubles. To get the proper date, use xlrd's date to tuple function: xldate_as_tuple
    metadataDateTuple=(xlrd.xldate_as_tuple(sh.cell_value(i, 8), wb.datemode)) # extract date from cell, convert to Gregorian time
    metadataDateList=map(int, metadataDateTuple) # create date in which each individual number (month, day etc.) is an integer
    ...
    LanguageCode=SubElement(languageCode, '{http://www.isotc211.org/2005/gmd}LanguageCode', {'codeListValue':'en', 'codeList':'#LanguageCode'})
    country=SubElement(PT_Locale, '{http://www.isotc211.org/2005/gmd}country')
    characterEncoding=SubElement(PT_Locale, '{http://www.isotc211.org/2005/gmd}characterEncoding')
    MD_CharacterSetCode=SubElement(characterEncoding, '{http://www.isotc211.org/2005/gmd}MD_CharacterSetCode', {'codeList':'http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_CharacterSetCode', 'codeListValue':"utf8"})
    ...
    referenceSystemIdentifier=SubElement(MD_ReferenceSystem, '{http://www.isotc211.org/2005/gmd}referenceSystemIdentifier')
    ...
    if sh.cell_value(i, 13) < 2013:
        ...
        resourceDateList=map(int, resourceDateTuple)
    ...
    CI_DateTypeCode=SubElement(resourceDateType, '{http://www.isotc211.org/2005/gmd}CI_DateTypeCode', {'codeList':'http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#CI_DateTypeCode',
    ...
    URIcode=SubElement(RS_Identifier, '{http://www.isotc211.org/2005/gmd}code')
    URIString=SubElement(URIcode, '{http://www.isotc211.org/2005/gco}CharacterString')
    ...
    CI_OnlineFunctionCode=SubElement(function, '{http://www.isotc211.org/2005/gmd}CI_OnLineFunctionCode', {'codeList':"http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#CI_OnLineFunctionCode",
    ...
    separateKeywords(MD_Keywords, keywordsEntered, numberKeywordsEntered)
    keywordType=SubElement(MD_Keywords, '{http://www.isotc211.org/2005/gmd}type')
    MD_KeywordTypeCode=SubElement(keywordType, '{http://www.isotc211.org/2005/gmd}MD_KeywordTypeCode', {'codeList':"http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_KeywordTypeCode",
    ...
    if sh.cell_value(i, 44)=="":
        ...
        if sh.cell_value(i, 44) < 2013:
            ...
            thesaurusDateList=map(int, thesaurusDateTuple)
    ...
    CI_DateTypeCode=SubElement(dateType, '{http://www.isotc211.org/2005/gmd}CI_DateTypeCode', {'codeList':'http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#CI_DateTypeCode',
    ...
    access_RestrictionCode=SubElement(accessConstraints, '{http://www.isotc211.org/2005/gmd}MD_RestrictionCode', {'codeList':"http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_RestrictionCode",
    ...
    use_RestrictionCode=SubElement(useConstraints, '{http://www.isotc211.org/2005/gmd}MD_RestrictionCode', {'codeList':"http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_RestrictionCode",
    ...
    MD_ClassificationCode=SubElement(classification, '{http://www.isotc211.org/2005/gmd}MD_ClassificationCode', {'codeList':"http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_ClassificationCode",
    ...
    spatialRepTypeCode=SubElement(spatialRepType, '{http://www.isotc211.org/2005/gmd}MD_SpatialRepresentationTypeCode', {'codeList':"http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_SpatialRepresentationTypeCode",
    ...
    MD_RepresentativeFraction=SubElement(equivalentScale, '{http://www.isotc211.org/2005/gmd}MD_RepresentativeFraction')
    ...
    if denominatorInt.text=="" and Distance.text=="":
    ...
    makeTopicCategories(MD_dataID, categoriesEntered, numberEntered)
    ...
    TimePeriod=SubElement(extent, '{http://www.opengis.net/gml/3.2}TimePeriod', {'{http://www.opengis.net/gml/3.2}id':"Temporal"})
    ...
    if sh.cell_value(i, 66)=="":
        ...
        if sh.cell_value(i, 66) < 2013:
            ...
            beginPositionList=map(int, beginPositionTuple)
    ...
    if sh.cell_value(i, 67)=="":
        ...
        if sh.cell_value(i, 67) < 2013:
            ...
            endPositionList=map(int, endPositionTuple)
    ...
    MD_DigitalTransferOptions=SubElement(transferOptions, '{http://www.isotc211.org/2005/gmd}MD_DigitalTransferOptions')
    ...
    MD_ScopeCode=SubElement(level, '{http://www.isotc211.org/2005/gmd}MD_ScopeCode', {'codeList':'http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_ScopeCode',
    ...
    if sh.cell_value(i, 74)=="":
        ...
        if sh.cell_value(i, 74) < 2013:
            ...
            reportDateList=map(int, reportDateTuple)
    ...
    # After all elements have been filled out, remove empty and unrequired elements
    removeGraphic(MD_dataID, graphicOverview)
    removeConstraints(MD_dataID, resourceConstraints)
    removeThesaurus(MD_dataID, descriptiveKeywords)
    removeQuality(root)
    #etree.dump(root)
